...
import pytest
from fhe_gwas_agent.models import FrontierPayload, ExecutionStatus
from fhe_gwas_agent.engine import FrontierDomainEngine
from fhe_gwas_agent.agents import EncryptedMatrixMultiplierAgent, ChiSquarePValueEvaluatorAgent, GenomicInflationFactorAgent, FHEGWASCoordinator
from fhe_gwas_agent.cli import main


def test_sub_agents():
    a1 = EncryptedMatrixMultiplierAgent()
    ...
    a2 = ChiSquarePValueEvaluatorAgent()
    ...
    a3 = GenomicInflationFactorAgent()
...
def test_coordinator():
    ...
    assert "iDASH Secure Genome Analysis Standards" in ans or "specifications" in ans
