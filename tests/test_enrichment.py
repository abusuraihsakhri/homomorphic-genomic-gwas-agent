"""
Automated Pytest for homomorphic-genomic-gwas-agent Enrichment Modules.
"""
import sys
...
from enrichment import (
    ...
    HomomorphicgenomicgwasagentEnrichmentSuite,
    enrichment_suite,
)

def test_enrichment_suite_execution():
    suite = HomomorphicgenomicgwasagentEnrichmentSuite()
